...
Route::group([
	...
	Route::group([
		...
		Route::patch('/{category}/edit', 'Admin\CategoryController@update')->name('update');
	...
	Route::patch('/{video}/edit', 'Admin\VideoDashboard@updateVideo')->name('updateVideo');
	Route::delete('/{video}/delete_video', 'Admin\VideoDashboard@deleteVideo')->name('deleteVideo');
